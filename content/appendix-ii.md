...
There is some overlap between this list and “Dealers: Individuals and Galleries” (in [Appendix I](/appendix-i/)), with some figures present in both (e.g., Joseph and Ernest Brummer, André Emmerich, and Dikran Kelekian). This list does not include well-known late nineteenth-century dealers (e.g., the Jandolo Family, nor the twentieth-century dealers for whom there is little to no documented information).
